...
if(isset($_POST['update_genre'])) {
    ...
    $genre_id = $con->updateGenre($id, $genrename);
    ...
    if ($genre_id) {
        ...
        $_SESSION ['error'] = "Error occurred while updating genre. Please try again.";
      }
  } else {
...
<div class="container my-5 border border-2 rounded-3 shadow p-4 bg-light">
  ...
  <h4 class="mt-5">Update Genre</h4>
  <form method="post" action="" novalidate>
    <div class="mb-3">
      <label for="genreName" class="form-label">Genre Name</label>
      <input type="text" name="genre_name" value="<?php echo $data['genre_name']; ?>" class="form-control" id="genreName" required>
    </div>
